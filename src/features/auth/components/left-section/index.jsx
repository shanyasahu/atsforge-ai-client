  ...
  return (
    <div>
      <div className="grid min-h-screen">
        {/* LEFT HERO SECTION */}
        <div
          className="relative flex flex-col justify-between p-12 text-white bg-cover bg-center"
          style={{ backgroundImage: `url(${frogBg})` }}
        >
          {/* Gradient overlay */}
          ...
          <div className="relative z-10 flex flex-col h-full justify-between">
            ...
            <div className="flex gap-6 flex-col">
              ...
              <div className="max-w-lg">
                ...
                <h1 className="md:text-5xl text-3xl font-extrabold text-green-400 mt-2">
                  ATSForge-AI
                </h1>

                <p className="mt-6 text-gray-300">
                  Evolve your career with the next generation of resume
                  optimization. Your professional evolution continues here.
                </p>
              </div>

              {/* Stats */}
              <div className="flex gap-10 text-green-400">
                <div>
